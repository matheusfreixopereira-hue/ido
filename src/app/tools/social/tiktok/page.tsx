      ...
      <main style={{ paddingTop: 88, paddingBottom: 64 }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", padding: "80px 0" }}>
            <div style={{ width: 72, height: 72, borderRadius: 24, background: "linear-gradient(135deg, #010101, #69c9d0)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 34, margin: "0 auto 24px", boxShadow: "0 8px 24px rgba(105,201,208,0.3)" }}>🎵</div>
            <h1 style={{ fontSize: 32, fontWeight: 900, marginBottom: 12 }}>TikTok Tools</h1>
            <p style={{ color: "var(--text-muted)", marginBottom: 32 }}>Profile photo resizer and cover simulator — coming soon!</p>
